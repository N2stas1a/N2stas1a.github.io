...
```
 ...
 ```chown user file
 ```
 - command is used to change a file owner. Thus,after command.
...
```
ananas@TestBarbarys01 ~]$ chmod g+s ./labExamples
[ananas@TestBarbarys01 ~]$ ls -l
total 8
drwxrwsrwx. 4 ananas ananas  44 Feb  4 22:11 labExamples
drwxr-xr-x. 8 ananas ananas 161 Jan 27 22:09 N2stas1a.github.io
[ananas@TestBarbarys01 ~]$ cd ./labExamples/
[ananas@TestBarbarys01 labExamples]$ ls -ld
drwxrwsrwx. 4 ananas ananas 44 Feb  4 22:11 .
[ananas@TestBarbarys01 labExamples]$ mkdir SGIDdir
[ananas@TestBarbarys01 labExamples]$ ls -l
total 0
drwx--S---. 2 ananas ananas 6 Feb  4 22:23 SGIDdir
```
##Sticky bit
...
```
ananas@TestBarbarys01 labExamples]$ umask 
0022
drwxrwxrwx. 2 ananas ananas 6 Jan 22 22:30 .
[ananas@TestBarbarys01 labExamples]$ mkdir exampledir1
[ananas@TestBarbarys01 labExamples]$ ls -l
total 0
drwxr-xr-x. 2 ananas ananas 6 Feb  4 22:11 exampledir1
[ananas@TestBarbarys01 labExamples]$ umask 077
[ananas@TestBarbarys01 labExamples]$ mkdir exampledir2
[ananas@TestBarbarys01 labExamples]$ ls -l
total 0
``` 
...
```
drwxr-xr-x. 2 ananas ananas 6 Feb  4 22:11 exampledir1
drwx------. 2 ananas ananas 6 Feb  4 22:11 exampledir2
```
